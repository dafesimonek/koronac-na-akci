...
import 'package:koronac_na_akci/src/service/app_config_service.dart';
import 'package:koronac_na_akci/src/state/app_config_state.dart';
import 'package:koronac_na_akci/src/state/persistent_state.dart';
import 'package:koronac_na_akci/src/state/serializers.dart';
...
class PersistenceService {
  StateHolder<AppConfigState> get appConfig =>
      getMyStateHolder<AppConfigState>();
  ...
  void _restorePersistentState(PersistentState p) {
    appConfig.state =
        appConfig.state.rebuild((b) => b..counter = p.counter ?? 0);
